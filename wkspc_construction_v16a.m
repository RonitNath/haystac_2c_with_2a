...
% "CHG15a"
% - v16a created by DP on 2/16/20. Is to v15a as v16 is to v15. Special changes from 15-->15a keep
% the "CHG15a" tag
% 
%% REFERENCES
...
%% ============================================================================================== %%
%% USER INPUT
ver = 'v16'; % keeps the v16 tag, not using 'a'
% data_run = '20190919';
...
f_lo_spec_Hz = 45E3;
f_hi_spec_Hz = 0.8E6; % 1.9E6; % CHG15a - smaller range
...
%         std_pt_monhot = std(pts_monhot, [], 'all');
        ...
        [OP_data.f4NH_IF_Hz, VF.N_Hp_test_1q_qta, ~] = FUNC_analyze_add_noise_v13a(OP_data, i, ...
            ...
            add_noise.I_hot, add_noise.Q_hot, save_figs, fig_folder, AMP_gain_meas);
        ...
        abg_test_out = FUNC_proc_abg_v5a(UNIV, OP_data, abg, i, abg_gain_tone_det_MHz, VF, ...
