function params_select = FUNC_valfct_v6(UNIV, OP_data, OP_ind, abg_test_out, VF, g_out, ...
...
%
%% HISTORY
% - v1 created by Dan Palken on 4 Dec 2019
% - v2 created by DP on 6 Dec 2019
% - v3 created by DP on 27 Dec 2019
% - v4 created by DP on 31 Dec 2019. Pairs with wkspc_construction_v14
% - v5 created by DP on 21 Jan 2020. Color-wheel based scheme
% - v6 created by DP on 24 Jan 2020 
%
%% REFERENCES
...
GSmin_crit = (GS >= VF.crit.Gs_min_1q_pow);
GSmin_crit_met = squeeze(sum(GSmin_crit, 2)/n_f_IFs >= VF.crit.fracmatch);
GSmax_crit = (GS <= VF.crit.Gs_max_1q_pow);
