function [f_IF_Hz, N_H_1q_qta, G_H_1q_pow] = FUNC_analyze_add_noise_v13b(OP_data, OP_ind, ...
    T_VTS_K, VF, S_c_known_1q_qta, det_gain_MHz, det_norm_tone_MHz, det_dc2cav_MHz, T_f_K, ...
    lambda, rho, alpha, f_IF_Hz, S_out_norm_1q, save_figs, fig_folder, AMP_gain_meas)
...
% "CHG15a"
% - v13b created by DP on 2/16/20. Pairs with wkspc_construction_v15b. Special changes flagged with 
% "CHG15b". From input arguments, 6 ENA arguments have been removed
%
%% REFERENCES
...
plot_results = 0;
% plot_ENA = 0; % CHG15b - option removed
plot_spectra = 0;
...
% CHG15b - this difference gives the center of the measurement
f_meanRF_GHz = OP_data.f_cav_t2_GHz - det_norm_tone_MHz*1E-3; 
