function [f_IF_Hz, N_H_1q_qta, G_H_1q_pow] = FUNC_analyze_add_noise_v13(OP_data, OP_ind, ...
    ...
    I_hot, Q_hot, save_figs, fig_folder)
...
cav_props.label = 'c'; % cold
g_out(1) = FUNC_cavcorrect_smart_gain_v1(f_ENA_GHz, P_tot_cold, auto_scale, cav_props);
cav_props.label = 'h'; % hot
g_out(2) = FUNC_cavcorrect_smart_gain_v1(f_ENA_GHz, P_tot_hot, auto_scale, cav_props);
