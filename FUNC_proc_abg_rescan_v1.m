function [abg_out] = FUNC_proc_abg_rescan_v1(UNIV, OP_data, abg, OP_ind, det_gain_MHz, VF, save_figs, ...
...
%
%% HISTORY
% - v1 created by Dan Palken on 3/24/20, based directly on FUNC_proc_abg_v5
%
%% REFERENCES
...
% for the rescan data, this is jsut a matter of setting G_s everywhere to 1:
G_s_test_pow = ones(size(N_Hp_fDep_1q_qta));
% this is here simply to mimic the non-rescan version's variables:
G_s_test_full_fdep_pow = G_s_test_pow;
